...
fun ChatAppTheme(
    ...
    val themeState = viewModel.darkModeState.collectAsState()
    ...
    CompositionLocalProvider(LocalThemeMode provides themeState.value) {
...
@Composable
fun isAppInDarkTheme(): Boolean = LocalThemeMode.current
